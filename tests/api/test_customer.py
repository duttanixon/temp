...
@pytest.mark.asyncio
async def test_get_all_customers_admin(client: TestClient, admin_token: str):
...
@pytest.mark.asyncio
async def test_get_all_customers_non_admin(client: TestClient, customer_admin_token: str):
...
@pytest.mark.asyncio
async def test_get_all_customers_pagination(client: TestClient, admin_token: str):
...
async def test_create_customer_admin(mock_create_thing_group, client: TestClient, db: AsyncSession, admin_token: str):
    ...
    await db.commit()
    result = await db.execute(select(Customer).filter(Customer.name == customer_data["name"]))
    created_customer = result.scalars().first()
...
@pytest.mark.asyncio
async def test_create_customer_existing_name(client: TestClient, admin_token: str, customer: Customer):
...
@pytest.mark.asyncio
async def test_create_customer_invalid_email(client: TestClient, admin_token: str):
...
@pytest.mark.asyncio
async def test_create_customer_non_admin(client: TestClient, customer_admin_token: str):
...
@pytest.mark.asyncio
async def test_get_customer_by_id_admin(client: TestClient, admin_token: str, customer: Customer):
...
@pytest.mark.asyncio
async def test_get_customer_by_id_engineer(client: TestClient, engineer_token: str, customer: Customer):
...
@pytest.mark.asyncio
async def test_get_customer_by_id_non_admin(client: TestClient, customer_admin_token: str, customer: Customer):
...
@pytest.mark.asyncio
async def test_get_customer_nonexistent_id(client: TestClient, admin_token: str):
...
@pytest.mark.asyncio
async def test_update_customer_admin(client: TestClient, db: AsyncSession, admin_token: str, customer: Customer):
    ...
    await db.commit()
    # Requery the customer to get updated data
    result = await db.execute(select(Customer).filter(Customer.customer_id == customer.customer_id))
...
@pytest.mark.asyncio
async def test_update_customer_nonexistent_id(client: TestClient, admin_token: str):
...
@pytest.mark.asyncio
async def test_update_customer_non_admin(client: TestClient, customer_admin_token: str, customer: Customer):
...
@pytest.mark.asyncio
async def test_suspend_customer(client: TestClient, db: AsyncSession, admin_token: str, customer: Customer):
    ...
    # Requery the customer to get updated data
    result = await db.execute(select(Customer).filter(Customer.customer_id == customer.customer_id))
    suspended_customer = result.scalars().first()
...
@pytest.mark.asyncio
async def test_suspend_customer_non_admin(client: TestClient, customer_admin_token: str, customer: Customer):
...
@pytest.mark.asyncio
async def test_suspend_nonexistent_customer(client: TestClient, admin_token: str):
...
@pytest.mark.asyncio
async def test_activate_customer(client: TestClient, db: AsyncSession, admin_token: str, suspended_customer: Customer):
    ...
    await db.commit()
    # Requery the customer to get updated data
    result = await db.execute(select(Customer).filter(Customer.customer_id == suspended_customer.customer_id))
    activated_customer = result.scalars().first()
...
@pytest.mark.asyncio
async def test_activate_customer_non_admin(client: TestClient, customer_admin_token: str, suspended_customer: Customer):
...
@pytest.mark.asyncio
async def test_activate_nonexistent_customer(client: TestClient, admin_token: str):
