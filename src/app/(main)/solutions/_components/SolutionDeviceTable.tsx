...
import { SolutionDeviceTableHeader } from "./SolutionDeviceTableHeader";
import { SolutionDeviceTableRow } from "./SolutionDeviceTableRow";

type SortKey = "name" | "device_type" | "customer_name";
type SortDirection = "asc" | "desc";

type SolutionDeviceTableProps = {
  children?: ReactNode;
  devices?: Device[];
  solution?: Solution;
 ...
 */
export const SolutionDeviceTable: FC<SolutionDeviceTableProps> = ({
  devices = [],
  solution,
