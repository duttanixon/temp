...
export default function TotalPeopleCard({
  ...
  return (
    <div className="flex flex-col gap-3">
      <Card className="h-full shadow-lg hover:shadow-xl transition-shadow rounded-none duration-300 flex flex-col">
      ...
      <Card className="h-full shadow-lg hover:shadow-xl transition-shadow rounded-none duration-300">
        <CardHeader className="pb-2 pt-3 px-4">
          <CardTitle className="text-base font-semibold text-gray-700">
            {subtitle}
          </CardTitle>
