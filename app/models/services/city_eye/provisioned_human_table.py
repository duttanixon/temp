...
class CityEyeProvisionedHumanTable(Base):
    __tablename__ = "city_eye_provisioned_human_data"
    ...
    # Relationships
    device = relationship("Device", backref="city_eye_provisioned_human_data")
    solution = relationship("Solution", backref="city_eye_provisioned_human_data")
    device_solution = relationship("DeviceSolution", backref="city_eye_provisioned_human_data")
