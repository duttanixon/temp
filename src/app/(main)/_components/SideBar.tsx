...
import { AlertCircle, BarChart2, Database, HeadphonesIcon, LayoutDashboard, Users } from 'lucide-react'
...
export function Sidebar() {
  ...
  return (
    <aside className="w-64 bg-[#34495E] text-white min-h-screen flex flex-col">
