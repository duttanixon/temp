...
interface FilterGroupProps {
  ...
  export function FilterGroup({ verticalTab, horizontalTab, customerId, solutionId }: FilterGroupProps) {
    ...
    const commonFilters = (
      ...
      return (
        <ScrollArea className="h-full py-4 pr-2"> {/* Added pr-2 for scrollbar spacing */}
          <div className="space-y-3"> {/* Increased spacing between filters */}
            {commonFilters}
            {showPeopleFilters && (
              <>
                <AgesFilter />
