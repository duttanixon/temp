...
def build_flow_eye_pipeline_string(pipe):
    ...
    person_attribute_post_process = os.path.join(os.path.dirname(os.path.abspath(__file__)), "hailopython", "attribute_prossprocess.py")
    person_attribute_segment = ATTRIBUTE_CLASSIFICATION_PIPELINE(person_attribute_post_process, pipe.person_attributes_model_path, pipe.batch_size)
