...
const CityEyeDeviceActions: FC<CityEyeDeviceActionsProps> = ({
  ...
  const handleEdit = (e: React.MouseEvent) => {
    e.stopPropagation();
    router.push(
      `/solutions/${solution?.solution_id}/actions/${device.device_id}/edit`
    );
  };
  ...
  const handlePolygonSettings = (e: React.MouseEvent) => {
    e.stopPropagation();
    router.push(
      `/solutions/${solution?.solution_id}/actions/${device.device_id}/polygon-settings`
    );
  };
  ...
  const handleLiveStream = (e: React.MouseEvent) => {
    e.stopPropagation();
    router.push(
      `/solutions/${solution?.solution_id}/actions/${device.device_id}/live`
    );
  };
