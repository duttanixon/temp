...
class RPICameraHandler:
    ...
    def __init__(self, pipeline, width:int, height:int, video_format: str, picamera_config: Optional[Dict]=None):
    ...
    def _caemra_thread(self):
        ...
        with Picamera2() as picam2:
            if self.picamera_config is None:
                ...
                config = picam2.create_preview_configuration(main=self.picamera_config["main"], lores=self.picamera_config["lores"], controls=self.picamera_config["controls"])
